"""Unified validation functions for all chemical engineering calculations"""

from typing import Union, Sequence, List, Dict, Optional, Any
import math
...
def normalize_composition(
    ...
    """Normalize composition to sum to 1.0 (Eq. 22.1-13)"""
    if len(z) < 2:
